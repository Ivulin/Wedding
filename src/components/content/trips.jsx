				...
				<Card>
					<Card.Body>
						...
						<Card.Text>
							...
							<Button className="pull-right" variant="primary" target="_blank" rel="noreferrer" href='http://www.maiskogel.at/de/maisiflitzer/'>Více...</Button>
						</Card.Text>
					</Card.Body>
				</Card>
				<Card>
					<Card.Body>
						...
						<Card.Text>
							...
							<Button className="pull-right" variant="primary" target="_blank" rel="noreferrer" href='https://www.burg-kaprun.at/'>Více...</Button>
						</Card.Text>
					</Card.Body>
				</Card>
				<Card>
					<Card.Body>
						...
						<Card.Text>
							...
							<Button className="pull-right" variant="primary" target="_blank" rel="noreferrer" href='https://www.baumzipfelweg.at/'>Více...</Button>
						</Card.Text>
					</Card.Body>
				</Card>
				<Card>
					<Card.Body>
						...
						<Card.Text>
							...
							<Button className="pull-right" variant="primary"  target="_blank" rel="noreferrer" href='https://www.golf-zellamsee.at/de/'>Více...</Button>
						</Card.Text>
					</Card.Body>
				</Card>
				<Card>
					<Card.Body>
						...
						Grossglocknerská vysokohorská silnice je již téměř 90 let jednou z nejmonumentálnějších památek Rakouska.
							<Button className="pull-right" variant="primary" target="_blank" rel="noreferrer" href='https://www.grossglockner.at/gg/de/index'>Více...</Button>
						</Card.Text>
					</Card.Body>
				</Card>
				<Card>
					<Card.Body>
						...
						<Card.Text>
							...
							<Button className="pull-right" variant="primary" target="_blank" rel="noreferrer" href='https://www.infoglobe.cz/tip-na-vylet/rakousko-kaprun-vysokohorske-prehrady-wasserfallboden-a-mooserboden/'>Více...</Button>
						</Card.Text>
					</Card.Body>
				</Card>
				<Card>
					<Card.Body>
						...
						<Card.Text>
							...
							<Button className="pull-right" variant="primary" target="_blank" rel="noreferrer" href='https://www.kitzsteinhorn.at/cz'>Více...</Button>
						</Card.Text>
					</Card.Body>
				</Card>
				<Card>
					<Card.Body>
						...
						<Card.Text>
							...
							<Button className="pull-right" variant="primary" target="_blank" rel="noreferrer" href='https://www.tauernspakaprun.com/de'>Více...</Button>
						</Card.Text>
					</Card.Body>
				</Card>
				<Card>
